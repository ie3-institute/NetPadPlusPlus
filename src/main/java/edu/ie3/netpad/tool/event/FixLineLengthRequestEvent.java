...
/**
 * An event, that is sent from {@link edu.ie3.netpad.tool.controller.ToolController} to
 * {@link edu.ie3.netpad.grid.controller.GridController} to request a fixing of line length discrepancy
 */
public class FixLineLengthRequestEvent implements ToolEvent {
    ...
    public FixLineLengthRequestEvent(LineLengthResolutionMode resolutionMode, Set<Integer> selectedSubnets) {
    ...
    public boolean equals(Object o) {
        ...
        return resolutionMode == that.resolutionMode &&
                selectedSubnets.equals(that.selectedSubnets);
    }
